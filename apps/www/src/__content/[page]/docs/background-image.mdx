...
<ComponentPropsTable name="BackgroundImageProps" />

@propsDescriptionSet:BackgroundImageProps

## BackgroundImageOptions Props

<ComponentPropsTable name="BackgroundImageOptions" />

@propsDescriptionSet:BackgroundImageOptions
