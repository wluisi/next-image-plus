...
<ComponentPropsTable name="PictureProps" />

@propsDescriptionSet:PictureProps

## Source Props

<ComponentPropsTable name="SourceProps" />

@propsDescriptionSet:SourceProps

## Img Props

<ComponentPropsTable name="ImgProps" />

@propsDescriptionSet:ImgProps
